...
function normalizeOscProfile(input = {}, defaults = {}) {
  ...
  const currentScenePort = Number.parseInt(String(src.currentScenePort ?? fallback.currentScenePort ?? 8005), 10);
  ...
  return {
    ...
    currentScenePort: Number.isInteger(currentScenePort) && currentScenePort >= 1 && currentScenePort <= 65535 ? currentScenePort : 8005,
