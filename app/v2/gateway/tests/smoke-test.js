...
async function main() {
  ...
  try {
    const scripts = {
      catalog: path.join(APP_ROOT, "v2", "modules", "catalog", "server", "server.js"),
      paths: path.join(APP_ROOT, "v2", "modules", "paths", "server", "server.js"),
      algorithm: path.join(APP_ROOT, "v2", "modules", "algorithm", "server", "server.js"),
      runtime: path.join(APP_ROOT, "v2", "modules", "runtime", "server", "server.js"),
      showControl: path.join(APP_ROOT, "v2", "modules", "show-control", "server", "server.js"),
      audience: path.join(APP_ROOT, "v2", "modules", "audience", "server", "server.js"),
      scriptAgent: path.join(APP_ROOT, "v2", "modules", "script-agent", "server", "server.js"),
      gateway: path.join(APP_ROOT, "v2", "gateway", "server", "server.js"),
    };
    ...
    services.push(spawnService("script-agent", scripts.scriptAgent, {
      ...
      V2_SCRIPT_AGENT_EXPRESS_MODULE: EXPRESS_FALLBACK,
    ...
    services.push(spawnService("gateway", scripts.gateway, {
      ...
      V2_GATEWAY_EXPRESS_MODULE: EXPRESS_FALLBACK,
