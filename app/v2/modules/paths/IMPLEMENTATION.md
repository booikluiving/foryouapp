...
- Mutaties gaan alleen naar de V2 Paths store: `app/v2/modules/paths/db/paths-store.json` of `V2_PATHS_STORE_PATH`.
...
- `tests/smoke-test.js` start de service, test health, read-model, editor-state, save/load, validation, evaluate en snapshot creation met een tijdelijke V2 store. De test hasht `app/data/live.sqlite*` voor en na de run en faalt als V1 data verandert.
