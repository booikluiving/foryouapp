(function () {
  ...
  async function saveCaptionStyle(style = readCaptionStyleControls()) {
    ...
    try {
      const response = await fetch("/v0/script-agent/teleprompter-parser/caption-style", {
        method: "POST",
  ...
  async function saveAutoCameraSwitch() {
    ...
    try {
      const response = await fetch("/v0/script-agent/teleprompter-parser/auto-camera", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
  ...
  async function parseManual() {
    ...
    try {
      const response = await fetch("/v0/script-agent/teleprompter-parser/parse", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
