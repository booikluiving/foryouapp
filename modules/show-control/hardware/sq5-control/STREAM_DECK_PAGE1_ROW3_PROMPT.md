...
- Bridge base URL: `http://127.0.0.1:3225`
- Gebruik HTTP-actions, geen OSC.
- De bridge moet draaien met snelle Stream Deck mute-polling, bij voorkeur: `V2_SHOW_CONTROL_SQ5_STREAMDECK_POLL_MS=500`.
...
```text
Knop 4 press: POST http://127.0.0.1:3225/api/streamdeck/brent/toggle
Knop 5 press: POST http://127.0.0.1:3225/api/streamdeck/megan/toggle
Knop 6 press: POST http://127.0.0.1:3225/api/streamdeck/booi/toggle
Knop 7 press: POST http://127.0.0.1:3225/api/streamdeck/allmics/toggle
Knop 8 press: POST http://127.0.0.1:3225/api/streamdeck/main/toggle
```
